...
- 在「仓库」页浏览已保存来源仓库内的全部 skill，用勾选列多选后「导入所选」或「更新所选」；单行也保留「导入」/「更新」按钮。
- 在「仓库」页管理多个来源仓库：可添加、命名、切换与删除；每个仓库旁以小组件显示其 skill 数量，点击某仓库即筛选出它的技能列表。
...
| 选择性导入仓库技能 | 在「仓库」页勾选列表中的多个 skill，点「导入所选」或「更新所选」批量处理；单行也保留「导入」/「更新」。 | 仅 DSH 本地技能 |
