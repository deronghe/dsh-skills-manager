...
// - 路由：/api/dsh-skills-manager/state | enable | disable | delete | import | folder/save | folder/clear | folder/refresh | github/import | github/clear
...
import { state, setSkillEnabled, deleteSkill, importSkill, saveSourceFolder, clearSourceFolder, syncSourceFolder, saveGitRepo, clearGitRepo, syncGitRepo, userRoots, logPath } from "./core.js";
