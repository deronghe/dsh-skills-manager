...
| Selectively import repo skills | On the **Repository** tab, tick skills in the list and select **Import selected** or **Update selected**; each row also has its own **Import**/**Update** action. | DSH-local skills only |
